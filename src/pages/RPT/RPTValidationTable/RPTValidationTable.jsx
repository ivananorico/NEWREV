...
export default function RPTValidationTable() {
  ...
  // Handle view details - FIXED: Now navigates to RPTValidationInfo
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-600 mt-1">
              {registrations.length} application{registrations.length !== 1 ? 's' : ''} found
            </p>
          </div>
          <button
            onClick={fetchRegistrations}
              ...
              <tr>
                <td colSpan="7" className="px-6 py-8 text-center text-gray-500">
                  <div className="flex flex-col items-center">
                    ...
                    <p className="text-gray-500">No property registration applications have been submitted yet.</p>
                  </div>
                </td>
              </tr>
            ) : (
